...
<div class="image-text-layout">
  <img src="Website/IMG_1895.jpg" alt="Image with text" class="image" width="200" height="200">
...
<div class="image-container">
  <figure>
    <img src="Website/IMG_1803.jpg" alt="Image 1" width="301" height="402">
    <figcaption>UNC Women's Soccer were 2024 National Champions!</figcaption>
  </figure>
  <figure>
    <img src="https://github.com/arthurlennard11/arthurlennard/blob/master/Website/Screenshot%202025-01-18%20at%2018.36.36.jpg?raw=true" alt="Image 2" width="301" height="402">
...
## Code
<a href="https://github.com/arthurlennard11/arthurlennard/blob/master/Website/PremPredictionModel.Rmd" class="btn-outline">View RMD</a>
...
## Presentation
<a href="Website/Modeling for Predictive Analysis in Soccer (1).pdf" class="btn-outline">View Slides</a>
...
## Code
<a href="https://github.com/arthurlennard11/arthurlennard/blob/master/Website/NYRB.Rmd" class="btn-outline">View RMD</a>
...
## Presentation 
<a href="https://github.com/arthurlennard11/arthurlennard/blob/master/Website/NYRB.pdf" class="btn-outline">View PDF</a>
...
## Code
<a href="https://github.com/arthurlennard11/arthurlennard/blob/master/Website/Notebook.ipynb" class="btn-outline">Download</a>
...
## Presentation 
<a href="https://github.com/arthurlennard11/arthurlennard/blob/master/Website/SAIL.pdf" class="btn-outline">View PDF</a>
...
```{r}
getwd()
setwd("/Users/arthurlennard/Documents/PersonalWebsite")
```
